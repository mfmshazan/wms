 ...
 */
export function InspectionTable({ inspections, onView, onDelete, onLogDefect, canLogDefect = true, canDelete = true }) {
    ...
    <>
      ...
      {viewInspection && (
        <InspectionDetailModal
          ...
          onLogDefect={canLogDefect ? onLogDefect : undefined}
        />
      )}
    </>
  );
