...
async function main() {
  ...
  await prisma.user.createMany({
    data: [
      { email: "admin@wms.dev", name: "Admin User", role: "ADMIN", passwordHash: password },
      { email: "operator@wms.dev", name: "Alice Tan", role: "OPERATOR", passwordHash: password },
      { email: "quality@wms.dev", name: "Bob Lim", role: "QUALITY", passwordHash: password },
    ],
  });
  ...
  await prisma.product.createMany({
    data: [
      { sku: "SKU-0001", name: "Arduino Nano Rev3", category: "Electronics", qty: 14, unit: "pcs", price: 12.49, minStock: 20, status: "active" },
      { sku: "SKU-0002", name: "Corrugated Box 30×20cm", category: "Packaging", qty: 340, unit: "pcs", price: 0.85, minStock: 100, status: "active" },
      { sku: "SKU-0003", name: "Organic Oat Flour 1kg", category: "Food & Beverage", qty: 58, unit: "kg", price: 3.2, minStock: 50, status: "inactive" },
    ],
  });
  ...
  await prisma.movement.createMany({
    data: [
      { movementId: "MOV-0001", type: "Inbound", sku: "SKU-0001", productName: "Arduino Nano Rev3", qty: 50, unit: "pcs", reason: "Purchase Order", reference: "PO-20250601", notes: "Initial stock received from supplier.", performedBy: "Alice Tan", timestamp: new Date("2025-06-01T09:15:00.000Z") },
      { movementId: "MOV-0002", type: "Outbound", sku: "SKU-0001", productName: "Arduino Nano Rev3", qty: 36, unit: "pcs", reason: "Sales Order", reference: "SO-20250603", notes: "", performedBy: "Bob Lim", timestamp: new Date("2025-06-03T14:40:00.000Z") },
      { movementId: "MOV-0003", type: "Inbound", sku: "SKU-0002", productName: "Corrugated Box 30×20cm", qty: 200, unit: "pcs", reason: "Purchase Order", reference: "PO-20250605", notes: "Re-stock before Q3 season.", performedBy: "Alice Tan", timestamp: new Date("2025-06-05T11:00:00.000Z") },
    ],
  });
  ...
  await prisma.inspection.create({
    data: {
      ...
      timestamp: new Date("2025-06-05T13:30:00.000Z"),
      criteria: {
        create: [
          { code: "C1", label: "Packaging intact", result: "Pass" },
          { code: "C2", label: "Quantity matches PO", result: "Pass" },
  ...
  await prisma.nCR.create({
    data: {
      ...
      assignedTo: "John Doe", targetDate: "2025-06-20", closedAt: null, timestamp: new Date("2025-06-11T10:00:00.000Z"),
      capas: {
        create: [
  ...
  await prisma.nCR.create({
    data: {
      ...
      assignedTo: "Alice Tan", targetDate: "2025-06-15", closedAt: null, timestamp: new Date("2025-06-06T09:00:00.000Z"),
    },
  });
  await prisma.nCR.create({
    data: {
      ...
      assignedTo: "Bob Lim", targetDate: "2025-05-25", closedAt: new Date("2025-05-22T14:30:00.000Z"), timestamp: new Date("2025-05-21T08:00:00.000Z"),
      capas: {
        create: [
